...
import com.example.mycharacterapp.presentation.navigation.NavigationWrapper
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            MyCharacterAppTheme {
                val getCitiesListService = charactersViewModel.charactersState.collectAsStateWithLifecycle()

                when (getCitiesListService.value) {
                    CharactersStates.Loading -> {
                        LoadingScreen()
                    }
